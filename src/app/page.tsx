            ...
            <div className="flex-[3] flex flex-col gap-6 overflow-y-auto pr-2 pb-8">
              ...
              <div className="glass-panel p-6 border-t border-l border-white/10 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-sm text-foreground/80">Сегодня, 15:30</span>
                </div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-sm flex items-center gap-1.5 px-2 py-1 bg-red-500/10 text-red-400 w-fit rounded-md border border-red-500/20">
                    <span className="w-1.5 h-1.5 rounded-full bg-red-400"></span> Высокий
                  </span>
                </div>
